...
# Author: Jaerock Kwon
# ----------------------------------------------------------------------------
# 12/1/2017: Change the location of cont.hh from catvehicle to mirvehicle 
#
# ----------------------------------------------------------------------------
*/
#include "mir.hh"
...
namespace gazebo
{
    ...
    void CatSteering::modelRead(const gazebo_msgs::ModelStates::ConstPtr& msg)
    {
       ...
       // gazebo::common::Time::MSleep(10);
        ...
        double a0,a1;
        a0 = steering_joints[0]->Position(); //GetAngle(0).Radian();
        a1 = steering_joints[1]->Position(); //GetAngle(0).Radian();
