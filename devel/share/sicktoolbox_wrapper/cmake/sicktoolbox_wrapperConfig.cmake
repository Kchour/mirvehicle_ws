...
if("TRUE" STREQUAL "TRUE")
  set(sicktoolbox_wrapper_SOURCE_PREFIX /home/mir-lab/mirvehicle_ws/src/sicktoolbox_wrapper)
  set(sicktoolbox_wrapper_DEVEL_PREFIX /home/mir-lab/mirvehicle_ws/devel)
  ...
  set(sicktoolbox_wrapper_INSTALL_PREFIX /home/mir-lab/mirvehicle_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mir-lab/mirvehicle_ws/src/sicktoolbox_wrapper/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sicktoolbox_wrapper_dep}_FOUND)
      find_package(${sicktoolbox_wrapper_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sicktoolbox_wrapper_dep} REQUIRED ${depend_list})
  endif()
